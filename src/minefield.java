import java.util.concurrent.ThreadLocalRandom; //for random number for mine placement
/*
    Generates 8x8 minefield with 10 mines. Not customizable.
...
public class minefield {
    ...
    public int setNumber(int x, int i){
    /*

    Detects the amount of surrounding mines:
